...
```
In this dataset, the weather event with the largest total number of injuries is `r injSname` with `r injSnum` injuries. 
The weather event with the largest total number of fatalities is `r fatSname` with `r fatSnum` fatalities recorded.
...
```
In this dataset, the weather event with the largest average number of injuries is `r injMname` with `r injMnum` injuries. 
The weather event with the largest average number of fatalities is `r fatMname` with `r fatMnum` fatalities recorded.
